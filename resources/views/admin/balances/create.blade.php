    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.balances.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('balance_amount') ? 'is-invalid' : '' }}" type="number" name="balance_amount" id="balance_amount" value="{{ old('balance_amount', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('update_date') ? 'is-invalid' : '' }}" type="text" name="update_date" id="update_date" value="{{ old('update_date') }}" required>
