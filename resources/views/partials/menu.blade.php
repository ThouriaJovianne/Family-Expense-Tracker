<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('expence_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.expences.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/expences") || request()->is("admin/expences/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.expence.title') }}
                </a>
            </li>
        @endcan
        @can('revenue_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.revenues.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/revenues") || request()->is("admin/revenues/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.revenue.title') }}
                </a>
            </li>
        @endcan
        @can('transfer_access')
